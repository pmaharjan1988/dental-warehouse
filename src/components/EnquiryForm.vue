          ...
          <q-card class="q-pa-md shadow-20 card-top-border" v-if="show_enq_form">
            ...
            <q-form @submit="onSubmit" class="q-gutter-md">
              <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12  q-pr-md q-pl-md">
                  <q-input filled prefix="+61" dense type="number" v-model="enq_form.mobile" label="Mobile Number *" lazy-rules :rules="[
              ...
              <q-input dense v-model="enq_form.desc" filled autogrow class=" q-pr-md q-pl-md" label="Description" lazy-rules :rules="[ val => val && val.length > 0 || 'Please Enter Description']" />
